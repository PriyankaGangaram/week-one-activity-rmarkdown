...
We have data about `r nrow(diamonds)` diamonds. Only `r nrow(diamonds) - nrow(smaller)` are larger than 1 carat. The distribution of the remainder is shown below:
